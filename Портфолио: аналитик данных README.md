...
<p>Выводы (итоги):<p>
<ol>
  <li>Итог в файлк курсовой проект на листе "Юнит-экономика" представлен калькулятор юнит-экокомики онлайн-кинотеатра. Также на листе представлены анализ данных, выводы и предложения по улучшению финансовых показателей кинотетра.</li>
</ol>
<br> 
